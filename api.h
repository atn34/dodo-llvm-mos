 ...
 */
void DRAW_SPRITE(byte* sprite, byte x, byte y,
                 byte w, byte h, byte f,
                 byte m);
...
*/
void CLEAR_SPRITE(byte x, byte y, byte w,
                  byte h);
...
*/
void DRAW_LINE(byte x0, byte y0, byte x1,
               byte y1, byte c);
...
*/
void COPY_BACKGROUND(byte* data, byte x, byte y,
                     byte w, byte h, byte dir);
